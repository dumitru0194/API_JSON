...
project_ids=()
available_hosts_file="/home/dimon/Desktop/git_test/All_hosts.txt"
...
for ((i = 0; i < total_projects; i++)); do
  ...
  custom_json+='{"Hosts": "'$project_name'", "Repository_Size": "'$project_size_human_readable'", "last_activity": "'$last_activity_at'", "Have_backup": "'$have_backup'"},'
